...
def read_csv_file(file_path):
   """Checks if csv file exists. If it does, reads the file and converts it to a dataframe.
   ...
   -------
   data: dataframe
      The dataframe from the information in the file.
   """
...
def plot_average_score_gender(ax, data, color, gender):
   """ Function to plot the barplot of the average scores, for each gender group.
  ...
  Returns
  -------
  Bar plot showing the average score for each experiment, for the specified gender group
  """
...
def plot_average_score_age(ax, experiment_list, data, title, xlabel, ylabel, color):
   """ Function to plot the barplot of the average scores, for each age group as subfigure.
   ...
   ax: axes object
      axes object subfigure
   data: list
      list containing the average scores for each experiment for a particular age group
   title: string
   ...
   color: string
      color each subfigure

   Returns
   -------
   Bar plot showing the average score for each experiment, for the specified age group of subfigure
   """
...
def plot_counts_breakdown(ax, experiment_list, young_data, old_data, category, title):
   """ Plot count breakdown for young and old participants
   ...
   ax.plot(range(len(experiment_list)), young_data,
